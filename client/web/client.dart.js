...
["", "client.dart", , U, {
  "^": "",
  main: [function() {
    var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "load", false), [null]);
  ...
  loadData: function() {
    var url, completer, t1, t2, t3;
    U.log("Loading data");
    url = "http://127.0.0.1:8080/weather/lwws?city=" + H.S($.cityCode);
    completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
    t1 = W.HttpRequest_getString(url, null, false).then$1(new U.loadData_closure(completer));
    t2 = $.Zone__current;
    t3 = P._registerErrorHandler(new U.loadData_closure0(), t2);
    t2.toString;
    t1._addListener$1(H.setRuntimeTypeInfo(new P._Future(0, t2, null, null, null, null, t3, null), [null]));
    return completer.future;
  },
  dartDom: function(jsonStr) {
    var jsonObj, forecasts, cells, text, bottomText, err, st, exception, t1;
    try {
      jsonObj = C.JsonCodec_null_null.decode$1(jsonStr);
      J.set$innerHtml$x(document.getElementById("forcastTitle"), "<br>" + H.S(J.$index$asx(jsonObj, "title")));
      forecasts = J.$index$asx(jsonObj, "forecasts");
      cells = document.getElementById("imageCells");
      for (; J.get$childNodes$x(cells).length !== 0;)
        J.deleteCell$1$x(cells, 0);
      J.forEach$1$ax(forecasts, new U.dartDom_closure());
      cells = document.getElementById("eachDayCells");
      for (; J.get$childNodes$x(cells).length !== 0;)
        J.deleteCell$1$x(cells, 0);
      J.forEach$1$ax(forecasts, new U.dartDom_closure0());
      J.set$innerHtml$x(document.getElementById("tableBottom"), "\u4e88\u5831\u767a\u8868\u6642\u523b \uff1a " + H.S(U.format1(J.$index$asx(jsonObj, "publicTime"))));
      text = J.$index$asx(J.$index$asx(jsonObj, "description"), "text");
      text = J.replaceAll$2$s(text, "\n\n", "\n");
      text = J.replaceAll$2$s(text, "\u3010", "\n\u3010");
      J.set$innerHtml$x(document.getElementById("descriptionArea"), C.JSString_methods.$add("\n", text));
      bottomText = C.JSString_methods.$add("\u6982\u6cc1\u767a\u8868\u6642\u523b \uff1a ", U.format1(J.$index$asx(J.$index$asx(jsonObj, "description"), "publicTime"))) + ("\n\n" + H.S(J.$index$asx(J.$index$asx(jsonObj, "copyright"), "title")));
      J.set$innerHtml$x(document.getElementById("descriptionBottom"), bottomText);
    } catch (exception) {
      t1 = H.unwrapException(exception);
      err = t1;
  ...
  format1: function(str) {
    ...
    if (typeof t2 !== "number")
      return t2.$sub();
    str = t1.substring$2(str, 0, t2 - 8);
    H.checkString(" ");
    return H.stringReplaceAllUnchecked(str, "T", " ");
  },
  log: function(message) {
    var t1, t2, t3;
    P.print(message);
    t1 = document.querySelector("#log");
    t2 = J.get$innerHtml$x(document.querySelector("#log"));
    t3 = "\n" + message;
    if (t2 == null)
      return t2.$add();
    J.set$innerHtml$x(t1, t2 + t3);
  },
  main_closure: {
    "^": "Closure:12;",
    call$1: function(ev) {
      var smenu, t1;
      U.loadData().then$1(new U.main__closure());
      smenu = document.getElementById("selectMenu");
      t1 = J.get$onChange$x(smenu);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new U.main__closure0(smenu)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    },
    $isFunction: true
  },
  main__closure: {
  ...
  main__closure0: {
    "^": "Closure:12;smenu_0",
    call$1: function(ev) {
      $.cityCode = J.get$value$x(this.smenu_0);
      U.loadData().then$1(new U.main___closure());
    },
    $isFunction: true
  },
  main___closure: {
  ...
  loadData_closure: {
    ...
    call$1: function(responseText) {
      var t1 = "JSON data loaded : " + H.S(responseText);
      P.print(t1);
      J.set$innerHtml$x(document.querySelector("#log"), "Log Messages:\n" + t1);
      this.completer_0.complete$1(0, responseText);
    },
    $isFunction: true
  },
  loadData_closure0: {
    "^": "Closure:12;",
    call$1: function(error) {
      U.log("requested data is not available : " + H.S(error));
    },
    $isFunction: true
  },
  dartDom_closure: {
    "^": "Closure:12;",
    call$1: function(forecast) {
      var tdElement, img, uri, t1, pathToSplit, t2;
      tdElement = W._ElementFactoryProvider_createElement_tag("td", null);
      img = document.createElement("IMG", null);
      uri = P.Uri_parse(J.$index$asx(J.$index$asx(forecast, "image"), "url"));
      t1 = uri;
      if (t1.get$_pathSegments() == null) {
        pathToSplit = t1._path;
        t2 = J.getInterceptor$asx(pathToSplit);
        if (t2.get$isEmpty(pathToSplit) !== true && t2.codeUnitAt$1(pathToSplit, 0) === 47)
          pathToSplit = t2.substring$1(pathToSplit, 1);
        t2 = J.getInterceptor(pathToSplit);
        t2 = t2.$eq(pathToSplit, "") ? C.List_empty : H.setRuntimeTypeInfo(new H.MappedListIterable(t2.split$1(pathToSplit, "/"), P.Uri_decodeComponent$closure()), [null, null]).toList$1$growable(0, false);
        t1._pathSegments = H.setRuntimeTypeInfo(new P.UnmodifiableListView(t2), [null]);
      }
      t1 = t1._pathSegments;
      J.set$src$x(img, "/weather/lwws?image=" + H.S(t1.get$last(t1)));
      J.set$children$x(tdElement, [img]);
      document.getElementById("imageCells").appendChild(tdElement);
    },
    $isFunction: true
  },
  dartDom_closure0: {
    ...
    call$1: function(forecast) {
      var tdElement, temp;
      tdElement = W._ElementFactoryProvider_createElement_tag("td", null);
      J.appendText$1$x(tdElement, J.$index$asx(forecast, "dateLabel"));
      J.appendText$1$x(tdElement, C.JSString_methods.$add("\n", J.$index$asx(forecast, "telop")));
      temp = J.$index$asx(J.$index$asx(forecast, "temperature"), "max");
      if (temp == null)
        J.appendText$1$x(tdElement, "\n\u6700\u9ad8\u6e29\u5ea6 \uff1a ---");
      else
        J.appendText$1$x(tdElement, "\n\u6700\u9ad8\u6e29\u5ea6 \uff1a " + H.S(J.$index$asx(temp, "celsius")) + "\u00b0C");
      temp = J.$index$asx(J.$index$asx(forecast, "temperature"), "min");
      if (temp == null)
        J.appendText$1$x(tdElement, "\n\u6700\u4f4e\u6e29\u5ea6 \uff1a ---");
      else
        J.appendText$1$x(tdElement, "\n\u6700\u4f4e\u6e29\u5ea6 \uff1a " + H.S(J.$index$asx(temp, "celsius")) + "\u00b0C");
      document.getElementById("eachDayCells").appendChild(tdElement);
    },
    $isFunction: true
  }
},
...
J.deleteCell$1$x = function(receiver, a0) {
  return J.getInterceptor$x(receiver).deleteCell$1(receiver, a0);
};
